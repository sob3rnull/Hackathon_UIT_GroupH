...
const CONDITION_HINTS: ConditionHint[] = [
  {
    ...
    label: "cardiac",
    pattern:
      /\b(chest pain|cardiac|heart|mi\b|myocardial|angina|palpitation|arrest)\b|ရင်ဘတ်အောင့်|ရင်ဘတ်နာ|နှလုံး|နှလုံးဖောက်|နှလုံးရပ်/i,
  },
  {
    condition: "stroke",
    label: "stroke",
...
const CRITICAL_HINTS =
  /\b(unconscious|unresponsive|arrest|not breathing|apnoe|gasping|severe|massive|profuse|shock|bp ?[0-8]?[0-9]\/|sats? ?[0-8][0-9]|gcs ?[3-9]\b)\b|သွေးပေါင် ?[0-8]?[0-9]\/|အောက်ဆီဂျင် ?[0-8][0-9]|သတိလစ်|အသက်မရှူ|အသက်ရှူမရ|အသက်ရှူခက်|အသက်ရှူကြပ်|နှလုံးရပ်|သွေးအများကြီး|သွေးထွက်များ|ရှော့ခ်|မတုံ့ပြန်|မေ့မြော|အောက်ဆီဂျင်နည်း/i;

const STABLE_HINTS =
  /\b(mild|minor|stable|alert|walking|superficial|no distress)\b|အနည်းငယ်|မပြင်းထန်|တည်ငြိမ်|သတိရှိ|လမ်းလျှောက်နိုင်/i;

const ICU_HINTS =
  /\b(unconscious|unresponsive|arrest|intubat|ventilat|shock|severe|gcs|sats? ?[0-8][0-9]|major)\b|သွေးပေါင် ?[0-8]?[0-9]\/|အောက်ဆီဂျင် ?[0-8][0-9]|သတိလစ်|အသက်မရှူ|အသက်ရှူမရ|အသက်ရှူကြပ်|နှလုံးရပ်|သွေးအများကြီး|သွေးထွက်များ|ရှော့ခ်|မတုံ့ပြန်|မေ့မြော|အောက်ဆီဂျင်နည်း|ပြင်းထန်/i;
