...
function seedDonations(): Donation[] {
  ...
  return [
    { id: "don-1", hospital_id: "mem-1", donor_name: "Daw Khin Myo", amount: 150000, message: "For the ER team.", payment_method: "kbz_pay", payer_phone: "0977001122", created_at: hourAgo },
    { id: "don-2", hospital_id: "mem-3", donor_name: "U Aung Ko", amount: 80000, message: "", payment_method: "aya_pay", payer_phone: "0966004455", created_at: dayAgo },
    { id: "don-3", hospital_id: "mem-1", donor_name: "Anonymous", amount: 50000, message: "Keep going!", payment_method: "card", payer_phone: "", created_at: dayAgo },
  ];
}
